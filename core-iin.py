...
from analytical_models.csm import CSMModel

from analytical_models.arnett import ArnettModel
from analytical_models.gaussian import GaussianModel
from dust_models import *
...
# Define the parameters for the GaussianModel
peak_luminosity = 1e42  # Example: 1e42 erg/s
duration = 20  # Example: 20 days (FWHM)
temperature = 6000  # Example: 6000 K
#my_model = GaussianModel(peak_luminosity, duration, temperature)



my_model = models.AnalyticalModel(CSMModel)

# Put in a dust model...
dustModel = LogUniformDust(1e-5, 0.5)
...
metric_list = {
    "snr3": (snr, (5,5,)),  # Example cutoff value of 3
    "snr5": (snr, (10,5,)),
